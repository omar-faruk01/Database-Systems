...
select * from AUTHOR;
--List all authors whose first name contains the letter pattern “IN.” Put the 
--results in order of last name, then first name. List each author’s last name 
--and first name
select lname, fname
from author
where fname like '%IN%'
...
select * from books;
--Use a search pattern to find any book title with “A” for the second letter and
-- “N” for the fourth letter. List each book’s ISBN and title. Sort the list by
